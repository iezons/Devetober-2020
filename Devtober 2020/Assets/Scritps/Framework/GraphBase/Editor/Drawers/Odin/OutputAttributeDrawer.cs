...
namespace GraphBaseEditor {
	public class OutputAttributeDrawer : OdinAttributeDrawer<GraphBase.Node.OutputAttribute> {
		...
		protected override void DrawPropertyLayout(GUIContent label) {
			...
			if (!NodeEditor.inNodeEditor) {
				if (Attribute.backingValue == GraphBase.Node.ShowBackingValue.Always || Attribute.backingValue == GraphBase.Node.ShowBackingValue.Unconnected && !port.IsConnected)
