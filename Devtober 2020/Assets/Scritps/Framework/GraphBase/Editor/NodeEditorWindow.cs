...
namespace GraphBaseEditor {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        public Dictionary<GraphBase.NodePort, Rect> portConnectionPoints { get { return _portConnectionPoints; } }
        private Dictionary<GraphBase.NodePort, Rect> _portConnectionPoints = new Dictionary<GraphBase.NodePort, Rect>();
        ...
        [System.Serializable] private class NodePortReference {
            [SerializeField] private GraphBase.Node _node;
            [SerializeField] private string _name;

            public NodePortReference(GraphBase.NodePort nodePort) {
                _node = nodePort.node;
                _name = nodePort.fieldName;
            }

            public GraphBase.NodePort GetNodePort() {
                if (_node == null) {
                    return null;
                }
        ...
        private void OnEnable() {
            ...
            if (length == _rects.Length) {
                for (int i = 0; i < length; i++) {
                    GraphBase.NodePort nodePort = _references[i].GetNodePort();
                    if (nodePort != null)
        ...
        public Dictionary<GraphBase.Node, Vector2> nodeSizes { get { return _nodeSizes; } }
        private Dictionary<GraphBase.Node, Vector2> _nodeSizes = new Dictionary<GraphBase.Node, Vector2>();
        public GraphBase.NodeGraph graph;
        ...
        private static void OnSelectionChanged() {
            GraphBase.NodeGraph nodeGraph = Selection.activeObject as GraphBase.NodeGraph;
        ...
        public static NodeEditorWindow Init() {
            ...
            w.titleContent = new GUIContent("GraphBase");
        ...
        public void SaveAs() {
            ...
            if (string.IsNullOrEmpty(path)) return;
                ...
                GraphBase.NodeGraph existingGraph = AssetDatabase.LoadAssetAtPath<GraphBase.NodeGraph>(path);
        ...
        public void SelectNode(GraphBase.Node node, bool add) {
            if (add) {
        ...
        public void DeselectNode(GraphBase.Node node) {
            List<Object> selection = new List<Object>(Selection.objects);
        ...
        public static bool OnOpen(int instanceID, int line) {
            GraphBase.NodeGraph nodeGraph = EditorUtility.InstanceIDToObject(instanceID) as GraphBase.NodeGraph;
            if (nodeGraph != null) {
                Open(nodeGraph);
                return true;
            }
        ...
        public static NodeEditorWindow Open(GraphBase.NodeGraph graph) {
            if (!graph) return null;

            NodeEditorWindow w = GetWindow(typeof(NodeEditorWindow), false, "GraphBase", true) as NodeEditorWindow;
            w.wantsMouseMove = true;
            w.graph = graph;
            return w;
        }
