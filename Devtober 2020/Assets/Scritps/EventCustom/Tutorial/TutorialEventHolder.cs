...
public class TutorialEventHolder : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        a("TU_SwitchToMainLevel", () => { GameManager.GetInstance().Stage = 1; GameManager.GetInstance().SetupStage(1); EventCenter.GetInstance().EventTriggered("TU_SwitchToMainLevel"); });
